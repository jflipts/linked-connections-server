                ...
                converter.resultStream(uncompressed_feed, (resultStream, stopsdb) => {
                    ...
                    resultStream.pipe(new Connections2JSONLD(baseURIs, stopsdb))
                        ...
                        .on('finish', async () => {
                            ...
                            } else if (dataset.tilingStrategy === "onelevel" || dataset.tilingStrategy === "multilevel" || dataset.tilingStrategy === "tree") {
                            ...
                            jsonLDStream.on('finish', async () => {
                                if (dataset.tilingStrategy === "multilevel" || dataset.tilingStrategy === "tree") {
                                ...
                                if (dataset.tilingStrategy === "tree") {
                                ...
                                comp.on('close', async code => {
                                    ...
                                    await writeFile(this.storage + '/tiles/' + companyName + '/' + dataset.zoom + '/tiles.json', JSON.stringify(tiles), 'utf8')
                                    logger.info('Available tiles dataset for ' + companyName + ' updated');
                                });
                            });
                        });
                });
